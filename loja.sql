...
--
-- Host: 127.0.0.1
-- Tempo de geração: 16-Abr-2020 às 16:40
...
INSERT INTO `cliente` (`id`, `nome`, `usuario`, `senha`, `telefone`, `endereco`, `estado`, `cidade`, `email`) VALUES
(4, 'Cliente', 'cliente', 'a60b85d409a01d46023f90741e01b79543a3cb1ba048eaefbe5d7a63638043bf', '(18) 11111-1111', 'Rua dos Antúrios 1135', 18, 5, 'cliente@cliente.com.br'),
(5, 'Rafa', '', '', '', '', 0, 0, ''),
(6, 'Rafa', '', '', '', '', 0, 0, ''),
(7, 'Rafa', '', '', '', '', 0, 0, ''),
(9, 'Lucas', 'sasdasdsad', '29a06645a7a175816f107238ebe3d01364fbc85a6952be13a1e6d350b47342ad', '(18) 99605-0204', '', 0, 0, ''),
(11, 'assdsadsd', 'adssadsad', '6759e63c99721c0793b126d949f5f7c50266f2d69db58270899a6514b28f8794', '(18) 99605-0204', 'sadsadsadsad', 5, 295, 'asdsadasd'),
(12, 'Rafa', '', '', '', '', 0, 0, ''),
(13, 'Rafa', '', '', '', '', 0, 0, ''),
(14, 'Rafa', '', '', '', '', 0, 0, ''),
(15, 'Rafa', '', '', '', '', 0, 0, ''),
...
INSERT INTO `funcionario` (`id`, `nome`, `usuario`, `senha`, `telefone`, `endereco`, `estado`, `cidade`, `email`) VALUES
(1, 'Funcionario', 'funcionario', '24d96a103e8552cb162117e5b94b1ead596b9c0a94f73bc47f7d244d279cacf2', '(18) 9999-9999', 'Rua Dos Andradas 32', 5, 10, 'funcionario@funcionario.com.br');
...
INSERT INTO `item_venda` (`quantidade`, `venda`, `produto`) VALUES
(1, 4, 17),
(2, 4, 18),
(1, 4, 19),
(1, 5, 17),
...
INSERT INTO `produto` (`id`, `descricao`, `valor`, `img`) VALUES
(16, 'THE WITCHER: WH', '189.85', 'jogo01.png'),
(17, 'FIFA 19', '132.50', '15864414505e8f2cea459cd.jpg'),
(18, 'ASSASSINS CREED: BF', '199.50', '15867965275e9497ef6d8d6.jpg'),
(19, 'FAR CRY 3', '149.80', '15868054195e94baab9f52a.jpg'),
(64, 'BATTLEFIELD V', '89.00', '15868055975e94bb5df1d08.jpg'),
(65, 'MAD MAX', '129.00', '15868103105e94cdc66e421.jpg');
...
INSERT INTO `venda` (`id`, `cliente`, `valor_total`) VALUES
(4, 5, '241.00'),
(5, 6, '201.00'),
(6, 7, '822.00'),
(7, 12, '278.80'),
...
ALTER TABLE `item_venda`
  ...
  ADD KEY `item_venda_produto_fk` (`produto`);
...
ALTER TABLE `venda`
  ADD PRIMARY KEY (`id`),
  ADD KEY `venda_cliente_fk` (`cliente`);
...
--
ALTER TABLE `item_venda`
  ADD CONSTRAINT `item_venda_produto_fk` FOREIGN KEY (`produto`) REFERENCES `produto` (`id`),
  ADD CONSTRAINT `item_venda_venda_fk` FOREIGN KEY (`venda`) REFERENCES `venda` (`id`);

--
-- Limitadores para a tabela `venda`
--
ALTER TABLE `venda`
  ADD CONSTRAINT `venda_cliente_fk` FOREIGN KEY (`cliente`) REFERENCES `cliente` (`id`);
COMMIT;
